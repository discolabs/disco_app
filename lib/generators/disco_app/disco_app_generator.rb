class DiscoAppGenerator < Rails::Generators::Base
  ...
  def setup_initializers
    ['shopify_app.rb', 'disco_app.rb'].each do |initializer_name|
      copy_file "initializes/#{initializer_name}", "config/initializers/#{initializer_name}"
    end
  end
  ...
  # Set up views.
  def setup_views
    ['layout/application.html.erb', 'home/index.html.erb'].each do |view_name|
      copy_file "views/#{view_name}", "app/views/#{view_name}"
    end
    ['layout/embedded_app.html.erb', 'home/index.html.erb'].each do |view_name|
