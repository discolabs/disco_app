...
$ cd example_app
$ echo "gem 'disco_app', git: 'https://$DISCO_GEM_CREDENTIALS@github.com/discolabs/disco_app.git', tag: '0.6.2'" >> Gemfile
$ bundle update
...
the tunnel endpoint), `SHOPIFY_APP_NAME`, `SHOPIFY_APP_REDIRECT_URI`, and
`SHOPIFY_APP_SCOPE` (view a [list of scopes][]). The `SHOPIFY_CHARGES_REAL`,
